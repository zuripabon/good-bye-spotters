...
export const priestDialog = [   
    { 
        dialog: hintInteractionTalk("Hello Spotter, I'm Francesco. Sure you have read I found a nice room and within minutes I was accepted ... <br>bullshit, all lies! I've been here for ages!...<br><br>This place ... this place is where I live. A cool developer build this for me so I have at least a place to stay<br>Help me get my booking request accepted. Would you help me?"),
        responses: [
    ...
    {
        dialog: hintInteractionTalk("Looks like you were rejected by the landlord ... would you help me again?"),
        responses: [
    ...
    {
        dialog: hintInteractionTalk("I heard in a grooming some devs are thinking on removing me<br> Ha!, poor guys, they dont know I'll remain in their git history forever ... <br> Oh you are still here, one more time?"),
        responses: [
